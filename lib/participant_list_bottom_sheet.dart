...
Future<void> showParticipantListBottomSheet(
  ...
  context: context,
  builder: (_) => ParticipantListBottomSheet(client: client, participantsUpdatedNotifier: participantsUpdatedNotifier),
);
              ...
              builder: (context, _) {
                ...
                return ListView.separated(
                  ...
                  itemBuilder: (_, index) {
                    ...
                    return Row(
                      children: [
                        Text(participant.info.username ?? 'Guest', style: Theme.of(context).textTheme.titleMedium),
                        const Spacer(),
